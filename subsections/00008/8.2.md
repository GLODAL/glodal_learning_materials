...
#### c. Hands-on guidance on how to implement Otsu’s method in Python
This tutorial provide the example to Image processing in notebooks, including visualizing the input data, plot histogram, and visualize output after apply Otsu's method.
