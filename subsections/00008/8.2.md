...
|      **Limitation**     |                    **Example**                    |
|-----------------|----------------------------------------------|
| Sometime, in bare land show dark similar as water. It may cause to error in this area when we extract water body from the image data.
  | ![limitation1-1](limitation1-1.JPG) ![limitation1-2](limitation1-2.JPG)|
