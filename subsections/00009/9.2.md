...
- Water Bodies: Dark in both HH and HV (low backscatter) because smooth water surfaces reflect radar energy away from the sensor.

- Vegetation: Bright in both HH and HV  due to leaves, branches, and trunks.

- Bare Soil/Open Areas: Varies depending on moisture and roughness but generally darker in both HH and HV due to the absence of volume scattering.

- Urban Areas: Bright in HH (high backscatter) due to buildings and infrastructure.
